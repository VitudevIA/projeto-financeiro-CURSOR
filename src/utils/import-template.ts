/**
 * Utilit├írio para gerar modelo de importa├º├úo de transa├º├Áes
 */
...
async function generateXLSXTemplate(headers: string[], examples: any[]) {
  // Tenta usar xlsx library se dispon├¡vel
  try {
    ...
    // Fallback para CSV
    console.warn('XLSX n├úo dispon├¡vel, usando CSV')
    generateCSVTemplate(headers, examples)
  }
}
